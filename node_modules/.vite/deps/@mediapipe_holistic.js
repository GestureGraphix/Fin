  ...
  "node_modules/@mediapipe/holistic/holistic.js"(exports) {
    (function() {
      ...
      function Ta(a) {
        a = +a;
        if (0 === a)
          0 < 1 / a ? I = J = 0 : (J = 0, I = 2147483648);
        else if (isNaN(a))
          J = 0, I = 2147483647;
        else {
          var b = 0 > a ? -2147483648 : 0;
          a = b ? -a : a;
          if (34028234663852886e22 < a)
            J = 0, I = (b | 2139095040) >>> 0;
      ...
      function Wa(a) {
        ...
        if (16 > a.length)
          ...
          a = BigInt(a), I = Number(a & BigInt(4294967295)) >>> 0, J = Number(a >> BigInt(32) & BigInt(4294967295));
        else {
          var b = +("-" === a[0]);
          J = I = 0;
          for (var c = a.length, d = b, e = (c - b) % 6 + b; e <= c; d = e, e += 6)
            d = Number(a.slice(d, e)), J *= 1e6, I = 1e6 * I + d, 4294967296 <= I && (J += I / 4294967296 | 0, I %= 4294967296);
      ...
      function Bb(a, b, c) {
        ...
        if (g)
          throw Error("Message parsing ended unexpectedly. Expected to read " + (e + " bytes, instead read " + (e - g) + " bytes, either the data ended unexpectedly or the message misreported its own length"));
        a.h.h = f;
        a.h.j = d;
      }
      function Cb(a, b, c) {
        var d = a.h.l();
        for (d = a.h.h + d; a.h.h < d; )
          c.push(b.call(a.h));
      }
      var Db = [];
      function Eb() {
      ...
      function Vb(a, b, c) {
        var d = false;
        if (null != a && "object" === typeof a && !(d = Array.isArray(a)) && a.fa === Ob)
          return a;
        if (d)
          return new b(a);
        if (c)
          ...
          case "object":
            if (a)
              if (Array.isArray(a)) {
                ...
                if (Ga && null != a && a instanceof Uint8Array)
                  return Ia(a);
                if (a instanceof jb) {
                  var b = a.V;
      ...
      function qc(a, b) {
        ...
        for (var g = e ? c.length - 1 : c.length, h = 0; h < g; h++)
          pc(a, d, h - a.G, c[h], false, f, b);
        if (e)
          for (var k in e)
            pc(a, d, +k, e[k], true, f, b);
        return d;
      }
      function bc(a) {
        if (!R(a.o))
      ...
      function X(a, b, c) {
        ...
        if (c) {
          ...
          for (k = 0; k < c.length; k++)
            g = c[k], g < e ? (g += this.G, (d = a[g]) ? rc(d, b) : a[g] = Qb) : (n || (n = Wb(this)), (d = n[g]) ? rc(d, b) : n[g] = Qb);
        }
      }
      ...
      var Z = Y(function(a, b, c) {
        ...
        if (eb) {
          ...
          for (var k = null, l, m; h < d; )
            l = a[h++], 128 > l ? e.push(l) : 224 > l ? h >= d ? ab() : (m = a[h++], 194 > l || 128 !== (m & 192) ? (h--, ab()) : e.push((l & 31) << 6 | m & 63)) : 240 > l ? h >= d - 1 ? ab() : (m = a[h++], 128 !== (m & 192) || 224 === l && 160 > m || 237 === l && 160 <= m || 128 !== ((f = a[h++]) & 192) ? (h--, ab()) : e.push((l & 15) << 12 | (m & 63) << 6 | f & 63)) : 244 >= l ? h >= d - 2 ? ab() : (m = a[h++], 128 !== (m & 192) || 0 !== (l << 28) + (m - 144) >> 30 || 128 !== ((f = a[h++]) & 192) || 128 !== ((g = a[h++]) & 192) ? (h--, ab()) : (l = (l & 7) << 18 | (m & 63) << 12 | (f & 63) << 6 | g & 63, l -= 65536, e.push((l >> 10 & 1023) + 55296, (l & 1023) + 56320))) : ab(), 8192 <= e.length && (k = bb(k, e), e.length = 0);
          h = bb(k, e);
        }
        T(b, c, h);
        return true;
        ...
        return D(function(p) {
          switch (p.h) {
            ...
            case 2:
              c = p.i;
              if ("object" === typeof window)
                return Od("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), Od("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), g = b.filter(function(n) {
                  ...
                  return D(function(w) {
                    if (1 == w.h)
                      return n = window.createMediapipeSolutionsWasm, q = window.createMediapipeSolutionsPackedAssets, t = a, C(w, n(q), 2);
                    t.i = w.i;
                    w.h = 0;
                  });
                }), m = function() {
      ...
      x.setOptions = function(a, b) {
        ...
        if (b = b || this.h.options) {
          for (var d = [], e = [], f = {}, g = A(Object.keys(a)), h = g.next(); !h.done; f = { X: f.X, Y: f.Y }, h = g.next())
                        ...
                        for (w = 0; w < n.length; ++w) {
                          ...
                          if (t.ba)
                            for (v = 0; v < t.ba.length; ++v)
                              E = q.data, M = E.addClassification, K = w, u = t.ba[v], F = new cd(), V(F, 2, u.score), u.index && T(F, 1, u.index), u.label && T(F, 3, u.label), u.displayName && T(F, 4, u.displayName), u = F.l(), M.call(E, K, u);
                        }
                        q = q.data;
                        break a;
                      default:
        ...
        return D(function(v) {
          switch (v.h) {
            case 1:
              ...
              f = A(Object.keys(c));
              for (g = f.next(); !g.done; g = f.next())
                h = g.value, k = c[h], "string" !== typeof k && "texture" === k.type && void 0 !== b[k.stream] && ++e;
              1 < e && (a.M = false);
              l = A(Object.keys(c));
              g = l.next();
            case 2:
      ...
      function Vd(a, b) {
        for (var c = b.name || "$", d = [].concat(B(b.wants)), e = new a.i.StringList(), f = A(b.wants), g = f.next(); !g.done; g = f.next())
          e.push_back(g.value);
      ...
      H("matrixDataToMatrix", function(a) {
        for (var b = a.getCols(), c = a.getRows(), d = a.getPackedDataList(), e = [], f = 0; f < c; f++)
          e.push(Array(b));
        for (f = 0; f < c; f++)
          for (var g = 0; g < b; g++) {
